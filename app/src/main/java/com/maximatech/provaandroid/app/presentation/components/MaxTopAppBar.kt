...
import com.maximatech.provaandroid.app.theme.StatusBarColor
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun MaxClientAppTopBar(title: String, onBackClick: () -> Unit) {
    ...
    Row(
        ...
        IconButton(onClick = onBackClick) {
            Icon(
                painter = painterResource(R.drawable.ic_maxima_voltar),
